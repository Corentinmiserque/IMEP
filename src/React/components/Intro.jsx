...
<section className="intro__right">
        ...
        <p className="intro__right__text__small">The Interdiocesan Institute (Institut Interdiocésain), the IMEP develops its action based on values of Christian inspiration. This action is rooted in the history of Catholic education, which has deeply worked for the humanization of society throughout the centuries.
